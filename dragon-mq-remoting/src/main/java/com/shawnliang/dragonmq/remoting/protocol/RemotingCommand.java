...
import com.shawnliang.dragonmq.logging.InternalLogger;
import com.shawnliang.dragonmq.logging.InternalLoggerFactory;
import com.shawnliang.dragonmq.remoting.CommandCustomHeader;
import com.shawnliang.dragonmq.remoting.annotation.CFNotNull;
...
import com.shawnliang.dragonmq.remoting.netty.RemotingSysResponseCode;
...
public class RemotingCommand {
    public static final String SERIALIZE_TYPE_PROPERTY = "dragon.serialize.type";
    public static final String SERIALIZE_TYPE_ENV = "ROCKETMQ_SERIALIZE_TYPE";
    public static final String REMOTING_VERSION_KEY = "dragon.remoting.version";
    ...
    private static RemotingCommand headerDecode(ByteBuf byteBuffer, int len, SerializeType type) throws RemotingCommandException {
        switch (type) {
            case JSON:
                ...
                return resultJson;
            case ROCKETMQ:
                RemotingCommand resultRMQ = DragonMQSerializable.rocketMQProtocolDecode(byteBuffer, len);
    ...
    private byte[] headerEncode() {
        ...
        if (SerializeType.ROCKETMQ == serializeTypeCurrentRPC) {
            return DragonMQSerializable.rocketMQProtocolEncode(this);
        } else {
    ...
    public void fastEncodeHeader(ByteBuf out) {
        ...
        if (SerializeType.ROCKETMQ == serializeTypeCurrentRPC) {
            ...
            headerSize = DragonMQSerializable.rocketMQProtocolEncode(this, out);
        } else {
            this.makeCustomHeaderToNet();
